...
.reason{
  ...
  <nav id="mainNav" class="navbar navbar-dark navbar-expand-md " >
      ...
      <div class="heading"><h1>Unpaid Fees</h1></div>

  <div class="container">
    <form action="AddPdf1" method="POST" id="usnform">
   <div class="row mb-3">
       <div class="col-12">
           <label for="usn"><h4>Enter USN of the student :</h4></label>
           <input type="text " class="border border-success rounded ml-5" id="usn" name="usn1">
   ...
   <div class="row">
            ...
            <tbody>
              ...
              <tr>
                <td>
                    <div class="row justify-content-between pr-5 pl-3">
                      <h4>Fee Status :</h4>
                      <input type="text" size="35" value='<%=request.getAttribute("fees")==null?"":request.getAttribute("fees")%>' class="border border-success rounded" disabled>
                    </div>
                  </td>
              </tr>
              <tr>
    ...
    <%
      ...
      <table class="table table-borderless rounded">   
        <form action="stored2" method="post">            
          <tbody>
            <tr>                   
                <td>
